defmodule Origami.Parser.Js.Keyword do
  ...
  @start_keywords ~w(NaN Infinity with super debugger continue try throw return var let const if switch case default for while break function import export delete)
  @other_keywords ~w(null this do in instanceof of else get set new catch finally typeof yield async await from as extends)
